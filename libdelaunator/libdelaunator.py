...
class Coordinates(_object):
    ...
    __swig_setmethods__["x"] = _libdelaunator.Coordinates_x_set
    __swig_getmethods__["x"] = _libdelaunator.Coordinates_x_get
    if _newclass:x = _swig_property(_libdelaunator.Coordinates_x_get, _libdelaunator.Coordinates_x_set)
    __swig_setmethods__["y"] = _libdelaunator.Coordinates_y_set
    __swig_getmethods__["y"] = _libdelaunator.Coordinates_y_get
    if _newclass:y = _swig_property(_libdelaunator.Coordinates_y_get, _libdelaunator.Coordinates_y_set)
...
class Delaunator(_object):
    ...
    def getIteratorVertexToNeighbourVertices(self, *args): return _libdelaunator.Delaunator_getIteratorVertexToNeighbourVertices(self, *args)
