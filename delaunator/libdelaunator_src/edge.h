...
class Edge {
        ...
        // ACCESSORS
                ...
                Edge* nextRightEdge()  const { return this->opposite_edge->next_left_edge->next_left_edge->opposite_edge;}
                ...
                void setLeftFace(Face* f, short ttl = 3) { // time to live permit an update on all sides of face.
                        this->left_face = f;
                        if(ttl > 0) {
